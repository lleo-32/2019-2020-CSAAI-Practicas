...
ctx.fillStyle = "white";
ctx.fillText(puntos_izquierda, 230, 80);
ctx.fillText(puntos_derecha, 325, 80);
  ...
  if (estado == ESTADO.SAQUE) {
    ...
    ctx.fillStyle = "pink";
    ctx.fillText("PRESS SPACE", 175, 220);
  }
  ...
  if (estado == ESTADO.INIT) {
    ctx.font = "30px Orbitron";
    ctx.fillStyle = "pink";
    ctx.fillText("PRESS START", 175, 220);
  }
}
  ...
  switch (e.key) {
    ...
    case " ":
      ...
      if (estado == ESTADO.SAQUE) {
        ...
        //-- Darle velocidad en ambas direcciones
        bola.vx = bola.vx_ini;
        bola.vy = bola.vy_ini;
